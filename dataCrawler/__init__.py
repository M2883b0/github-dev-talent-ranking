...
from utility.config import TOPICS_TABLE_NAME, TOPICS_URL_TABLE_NAME, USER_LOGIN_NAME_TABLE_NAME, USER_TABLE_FIELD, \
    USER_TABLE_NAME
...
if _users:
    ...
    crawled_users = {key["id"]: key['followers'] for key in database.query_data(USER_TABLE_NAME)}
